...
@NgModule({
  declarations: [FaqAssistantComponent, FaqAssistantButtonComponent],
  imports: [
    BrowserModule
  ],
  exports: [FaqAssistantComponent, FaqAssistantButtonComponent]
})
export class FaqAssistantModule {
  static forRoot(): ModuleWithProviders {
    return {
      ngModule: FaqAssistantModule,
      providers: [FaqItemListService, CommunicationFaqAssistantService]
    };
  }
}
